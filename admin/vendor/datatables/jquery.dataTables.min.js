...
(function(h) {
    ...
    function lb(a) {
        ...
        i && (e = h("<tr/>").appendTo(g));
        b = 0;
        for (c = l.length; b < c; b++) f = l[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ma(a, f.nTh, b))), f.sTitle != d[0].innerHTML && d.php(f.sTitle), Na(a, "header")(a, d,
            f, m);
        i && ea(a.aoHeader, g);
    ...
    function P(a) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1);
            ...
            } else c = f.sZeroRecords, 1 == a.iDraw && "ajax" == y(a) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = h("<tr/>", { "class": e ? d[0] : "" }).append(h("<td />", { valign: "top", colSpan: V(a), "class": a.oClasses.sRowEmpty }).php(c))[0];
    ...
    function rb(a) { return h("<div/>", { id: !a.aanFeatures.r ? a.sTableId + "_processing" : null, "class": a.oClasses.sProcessing }).php(a.oLanguage.sProcessing).insertBefore(a.nTable)[0] }
    ...
    function Gb(a,
        b) { var c = Hb(a, b); if (0 > c) return null; var d = a.aoData[c]; return !d.nTr ? h("<td/>").php(B(a, c, b, "display"))[0] : d.anCells[b] }
        ...
        if (!0 === a) this.child.show();
            ...
            var d = c[0],
                ...
                f = function(a, b) {
                    ...
                    else a.nodeName && "tr" === a.nodeName.toLowerCase() ? e.push(a) : (c = h("<tr><td/></tr>").addClass(b), h("td", c).addClass(b).php(a)[0].colSpan = V(d), e.push(c[0]))
                };
            f(a, b);
                    ...
                    o = function(b, d) {
                        ...
                        for (s = d.length; k < s; k++) {
                            ...
                            if (h.isArray(r)) {
                                ...
                                if (m !== null) {
                                    u = h("<a>", { "class": g.sPageButton + " " + l, "aria-controls": a.sTableId, "aria-label": i[r], "data-dt-idx": n, tabindex: a.iTabIndex, id: c === 0 && typeof r === "string" ? a.sTableId + "_" + r : null }).php(m).appendTo(b);
                                    Wa(u, { action: r }, v);
                                    n++
                                }
                            }
