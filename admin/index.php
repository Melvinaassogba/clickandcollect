                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                try
                                        ...
                                        $reponseTwo = $bdd->query('SELECT * FROM utilisateur');
                                        //$donneesTwo = $reponseTwo->fetch();

                                
                                ?>

                                </span>
                                <img class="img-profile rounded-circle" src="img/supadmin.jpeg">
                            </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Administrateur</div>
                                        ...
                                        $reponse = $bdd->query('SELECT COUNT(*) AS Nbr FROM utilisateur WHERE id_acces=2');
                                        $donnees = $reponse->fetch();

                                        //$reponseTwo = $bdd->query('SELECT * FROM utilisateur WHERE login = ?');
                                        //$donneesTwo = $reponseTwo->fetch();
                        ...
                        <div class="col-xl-6 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Marchand</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                        ...
                                        try
                                        {
                                         ...
                                         $reponse = $bdd->query('SELECT COUNT(*) AS Nbr FROM utilisateur WHERE id_acces="3"');
                        ...
                        <div class="col-xl-6 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Catégorie</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                        ...
                                        try
                                        {
                                         ...
                                         $reponse = $bdd->query('SELECT COUNT(*) AS Nbr FROM categorie');
                        ...
                        <div class="col-xl-6 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Produits</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                        try
                                        {
                                        ...
                                        $reponse = $bdd->query('SELECT COUNT(*) AS Nbr FROM produit');
                        ...
                        <div class="col-xl-6 col-sm-6 col-mx-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Super Administrateur </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 15rem;" src="img/supadmin.jpeg" alt="">
                                    </div>
                                    <p> Le super administrateur a tous les droits sur la plateforme Click And Collect.</p>
