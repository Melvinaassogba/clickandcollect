...
<head>
    ...
    <title>Click And Collect - Forgot Password</title>
                            ...
                            <div class="col-lg-6 ">
                                <div class="p-5 ">
                                    <div class="text-center ">
                                        ...
                                        <p class="mb-4 ">Saississez votre adresse mail !</p>
                                    </div>
                                    <form class="user ">
                                        ...
                                        <a href="login.php " class="btn btn-primary btn-user btn-block ">Réinitialiser le mot de passe</a>
                                    </form>
                                    <hr>
                                    <div class="text-center ">
